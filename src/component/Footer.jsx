      ...
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-8 py-10 border-t-2 border-pink-300/50 text-gray-800">
          ...
          <div className="py-4 px-2">
            ...
            <ul className="space-y-4 text-lg font-medium">
              <li><a href="#" className="hover:text-[#f5831fdd] duration-200">🍓 Strawberries</a></li>
              <li><a href="#" className="hover:text-[#f5831fdd] duration-200"><img src={RaspberryImage} alt="" className="inline h-5 w-5 mr-2" />
              Raspberries</a></li>
              <li><a href="#" className="hover:text-[#f5831fdd] duration-200">🌱 Organic Berries</a></li>
              <li><a href="#" className="hover:text-[#f5831fdd] duration-200">🥗 Seasonal Picks</a></li>
            </ul>
          </div>
          ...
          <div className="py-4 px-2">
            ...
            <ul className="space-y-4 text-lg">
              <li><span className="font-medium">📞 Phone:</span> +91 7021786968 , 8329652260</li>
              <li><span className="font-medium">✉️ Email:</span> ssfberries@gmail.com</li>
              {/* <li>
        ...
        <div className="text-center py-5 border-t border-pink-300/50">
          <span className="text-base text-gray-700 font-medium">
            © {new Date().getFullYear()} <span className="text-[#f5821f] font-bold">SSF BERRIES</span>. All Rights Reserved.
          </span>
        </div>
      </div>
    </div>
