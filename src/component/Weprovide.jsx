      ...
      <div className="max-w-auto mx-auto grid md:grid-cols-2 items-center gap-10 md:gap-16">
        ...
        <div className="text-left md:ml-3">
          ...
          <p className="text-[#2B5C00] text-md md:text-lg italic mt-2 md:mt-10 text-justify">
            Our fruits are carefully handpicked at peak ripeness and then frozen
            using Individually Quick Freezing (IQF) and blast freezing methods.
            This process preserves their rich taste and nutritional value,
            ensuring that every bite is as fresh as the day they were harvested.
          </p>
        </div>
        {/* Image Section */}
